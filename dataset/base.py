...
import numpy as np
import math
from dataset.draw_gaussian import draw_umich_gaussian, gaussian_radius
from dataset.transforms import random_flip, load_affine_matrix, random_crop_info, ex_box_jaccard
import dataset.data_augment
...
class BaseDataset(data.Dataset):
    ...
    def processing_test(self, image, input_h, input_w):
        ...
        out_image = out_image.reshape(1, 3, input_h, input_w)
